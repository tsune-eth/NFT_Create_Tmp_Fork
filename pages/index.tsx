...
const Home: NextPage = () => {
  ...
  const contractAddress = "0xd4C1946BF96E2e368856e8559Cc0B107E005F8cD"
  useEffect(() => {
  ...
  function MintButton() {
      ...
      try{
        await (window as any).ethereum.request({
          ...
          params: [{
            ...
            rpcUrls: ['https://goerli.infura.io/v3/1030d386393242e0a6f3bacfce773e56'],
          }],
        });
        console.log('try');
        setDisabledFlag(true);
    ...
    <div className="bg-black pb-16 flex flex-wrap buttom justify-center">
      <div className='px-8 pt-8 lg:px-28 lg:py-28'>
        <Image className="min-w-full" src="/base.avif" alt="Main Image" width={500} height={500}/>
      </div>
      <div className="m-12 lg:m-32 px-12 py-6 lg:pt-8 lg:px-20 border-2 bg-black text-center border-[#FFFFFF] bg-center bg-contain bg-no-repeat">
        <h1 className="text-2xl lg:text-4xl pt-2 lg:pt-4 lg:pb-6 text-white font-['Impact']">Identi Key</h1>
        <h1 className="text-2xl lg:text-4xl pt-2 lg:pt-4 lg:pb-6 text-white font-['Impact']"> {mintNum} / 10000</h1>
        <a className="text-2xl lg:text-4xl pt-2 lg:pt-8 lg:pb-8 text-white font-['Impact']">10</a><a className="text-2xl lg:text-3xl pt-2 lg:pt-8 lg:pb-8 text-[#99CDDB] font-['Impact'] ">MAX</a><br/>
  ...
  return (
    <div>
      <Seo
          pageTitle={'Identi Key'}
          pageDescription={'Identi Key'}
          pageImg={''}
          pageImgWidth={1920}
          pageImgHeight={1005}
      />
